...
#CHECK VISUAL STUDIO EDITON
#hkey_local_machine=Win32::Registry::HKEY_LOCAL_MACHINE
#hkey_current_user=Win32::Registry::HKEY_CURRENT_USER
#def $vs_edition
    #return getKeyValue(hkey_local_machine,"SOFTWARE\\Microsoft\\VisualStudio\\15.7,"")
#end
#if $vs_edition = getKeyValue(hkey_local_machine,"SOFTWARE\\Microsoft\\VisualStudio\\15.7,"")
    #return "Community"
    #if $vs_edition = getKeyValue(hkey_local_machine,"SOFTWARE\\Microsoft\\VisualStudio\\15.7,"")
        #return "Professional"
    #else
