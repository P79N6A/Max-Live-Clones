...
instr 1
    ...
    idist chnget "i_g_dist" ; grain distribution (0=periodic, 1=scattered)
    ...
    kPosScale  chnget "k_posScale"; # to multiply with position [0,1]
    ...
    iFileSize       = 1
    iFileSizeMS     = (iFileLength / sr) * 1000
    iFile1DSizeMS   = 1 / iFileSizeMS
    ...
    ; Time Pointer
    kPos = kPos * kPosScale
    ;kPos portk kPos, kPosGlide, iPos
    kPos lineto kPos, kPosGlide
    afilposphas upsamp kPos   
    afilposphas wrap afilposphas, 0, iFileSize 
