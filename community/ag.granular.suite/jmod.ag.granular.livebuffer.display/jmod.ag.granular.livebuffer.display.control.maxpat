...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 257.989258, 505.0, 465.0, 19.0 ],
					"text" : "jcom.message display/clear @type none @repetitions/allow 1 @description \"clear display\""
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 190.493164, 255.0, 32.5, 18.0 ],
									"text" : "t l l"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 263.890625, 177.5, 59.5, 18.0 ],
									"text" : "t b b b 0"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 106.993164, 390.010498, 116.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "bang", "bang", "bang", "int" ],
									"patching_rect" : [ 123.890625, 177.5, 59.5, 18.0 ],
									"text" : "t b b b 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 304.390625, 225.5, 142.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 225.5, 68.0, 16.0 ],
									"text" : "forceredraw"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 150.890625, 360.010498, 158.0, 19.0 ],
									"text" : "s #0_sample_display_in[1]"
								}
...
,
					"patching_rect" : [ 1543.0, 207.0, 123.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1543.0, 156.406006, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.0, 274.0, 79.0, 18.0 ],
					"text" : "vexpr $f1 / 255"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 357.0, 325.0, 32.5, 18.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.0, 300.0, 110.0, 18.0 ],
					"text" : "prepend headercolor"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 303.0, 187.0, 32.5, 16.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 257.989258, 702.0, 599.0, 31.0 ],
					"text" : "jcom.parameter display/verticalZoom @type integer @range/clipmode low @range/bounds 0 1 @repetitions/allow 0 @description \"zoom display vertically\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 949.25, 689.0, 321.0, 18.0 ],
					"text" : "<- outlet to be connected to the leftmost inlet of ftm.editor"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 257.989258, 382.0, 604.0, 31.0 ],
					"text" : "jcom.message selection/set @type integerArray @repetitions/allow 1 @description \"start and end (in ms) of a region to be highighted on the display\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 545.489258, 646.0, 146.079102, 17.0 ],
					"presentation_rect" : [ 545.489258, 646.0, 146.079102, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 257.989258, 592.0, 594.0, 43.0 ],
					"text" : "jcom.parameter livebuffer/slotNumber @type integer @range/clipmode low @range/bounds 0 @repetitions/allow 0 @description \"source slot number in the engine~, to which the livebuffer displayed on this display has been assigned. Only grains which use the audio from this slot will be highlighted on this display \""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1046.5, 100.616455, 477.0, 18.0 ],
					"text" : "jcom.parameter highlightGrains @type boolean @description \"enable real time grain highlighting\""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 514.489258, 251.416504, 46.0, 18.0 ],
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 647.989258, 280.0, 50.0, 27.0 ],
					"text" : "255 204 102"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 4,
					"numoutlets" : 0,
					"patching_rect" : [ 438.322601, 360.0, 59.5, 18.0 ],
					"text" : "bgcolor"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 438.322601, 310.0, 66.0, 16.0 ],
					"text" : "179 179 179"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 413.989258, 81.616455, 46.0, 18.0 ],
					"text" : "jcom.in"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 257.989258, 215.0, 532.0, 18.0 ],
					"text" : "jcom.parameter selected @type boolean @description \"mark display as selected: changes background color\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 914.0, 689.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.0, 121.616455, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 29.0, 47.23291, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 29.0, 81.616455, 377.0, 18.0 ],
					"text" : "jcom.hub @description \"waveform and grain highlight display for live buffer\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 548.489258, 416.0, 482.978516, 17.0 ],
					"presentation_rect" : [ 548.489258, 416.0, 482.978516, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 548.489258, 445.0, 158.0, 19.0 ],
					"text" : "s #0_sample_display_in[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 548.489258, 765.0, 159.0, 19.0 ],
					"text" : "s #0_sample_display_in[1]"
				}
...
,
					"patching_rect" : [ 5.0, 221.666656, 187.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial Bold",
						"default_fontsize" : 10.0,
...
,
					"patching_rect" : [ 5.0, 177.666656, 170.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial Bold",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 83.612305, 708.5, 150.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 319.873718, 1.02301, 87.747437, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 825.0, 100.616455, 150.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 219.0, 1.0, 83.747437, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1275.5, 263.5, 33.0, 16.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 914.0, 651.716553, 157.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1275.5, 287.5, 138.0, 18.0 ],
					"text" : "v #0_update_region_flag"
				}
...
, 			{
				"box" : 				{
					"annotation" : "enable real time grain highlighting",
					"bordercolor" : [ 0.392157, 0.392157, 0.392157, 1.0 ],
					"hint" : "/highlightGrains - toggles realtime waveform display and grain highlighting",
					"id" : "obj-127",
					"maxclass" : "toggle",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 995.25, 100.616455, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 294.747437, 4.02301, 14.0, 14.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1275.5, 239.406006, 32.5, 18.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1315.0, 156.406006, 208.0, 24.0 ],
...
,
					"patching_rect" : [ 825.0, 184.616455, 194.0, 28.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Verdana",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 853.0, 150.616455, 98.0, 24.0 ],
					"text" : "<- sync inlet",
...
,
					"patching_rect" : [ 825.0, 221.416504, 141.0, 28.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Verdana",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 548.489258, 744.0, 191.410156, 17.0 ],
					"presentation_rect" : [ 548.489258, 744.0, 191.410156, 17.0 ],
...
, 			{
				"box" : 				{
					"annotation" : "zoom display vertically",
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 26.612305, 708.5, 48.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 398.873718, 2.02301, 48.0, 16.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 164.0, 148.0, 19.0 ],
									"text" : "s #0_sample_display_in[1]"
								}
...
,
					"patching_rect" : [ 5.612305, 155.406006, 93.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Verdana",
						"default_fontsize" : 10.0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 29.5, 246.0, 230.760742, 17.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 43.0, 314.0, 512.616211, 17.0 ],
...
,
					"patching_rect" : [ 5.0, 199.666656, 159.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Verdana",
						"default_fontsize" : 10.0,
