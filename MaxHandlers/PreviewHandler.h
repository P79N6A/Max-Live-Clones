...
#include <afxext.h>
#include "..\Max\MaxDoc.h"
#include "..\Max\MaxView.h"
...
public:
	virtual HRESULT InitializeDocumentPreview(HWND hWndParent, RECT* prc)
	{
		...
		CCreateContext ctx;
		ctx.m_pNewViewClass = RUNTIME_CLASS(CMaxView);
		...
		m_pDocument->AddRef();
		ctx.m_pCurrentDoc = DYNAMIC_DOWNCAST(CMaxDoc, (CObject*) m_pDocument->GetContainer());
