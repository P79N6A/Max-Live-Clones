...
typedef struct _MaxHandlers_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } MaxHandlers_MIDL_TYPE_FORMAT_STRING;

typedef struct _MaxHandlers_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } MaxHandlers_MIDL_PROC_FORMAT_STRING;

typedef struct _MaxHandlers_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } MaxHandlers_MIDL_EXPR_FORMAT_STRING;
...
extern const MaxHandlers_MIDL_TYPE_FORMAT_STRING MaxHandlers__MIDL_TypeFormatString;
extern const MaxHandlers_MIDL_PROC_FORMAT_STRING MaxHandlers__MIDL_ProcFormatString;
extern const MaxHandlers_MIDL_EXPR_FORMAT_STRING MaxHandlers__MIDL_ExprFormatString;
...
static const MaxHandlers_MIDL_PROC_FORMAT_STRING MaxHandlers__MIDL_ProcFormatString =
    {
        0,
        {
...
static const MaxHandlers_MIDL_TYPE_FORMAT_STRING MaxHandlers__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Object interface: IPreview, ver. 0.0,
   GUID={0xc086684c,0x7bac,0x4fd9,{0xb8,0xf1,0x37,0x75,0x48,0x27,0x15,0xee}} */
...
/* Object interface: IThumbnail, ver. 0.0,
   GUID={0x0bb30d35,0x7d43,0x480b,{0x95,0x9a,0x04,0x10,0xb9,0xcc,0xb0,0xc2}} */
...
/* Object interface: ISearch, ver. 0.0,
   GUID={0xc18fc64e,0xfadc,0x4412,{0xa5,0xda,0x8b,0x53,0xde,0xb5,0x0c,0xe6}} */
...
static const MIDL_SYNTAX_INFO IPreview_SyntaxInfo [  2 ] = 
    ...
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    0,
    MaxHandlers__MIDL_ProcFormatString.Format,
    &IPreview_FormatStringOffsetTable[-3],
    MaxHandlers__MIDL_TypeFormatString.Format,
    0,
    0,
    0
    }
...
const CInterfaceProxyVtbl * const _MaxHandlers_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * const _MaxHandlers_StubVtblList[] = 
{
...
PCInterfaceName const _MaxHandlers_InterfaceNamesList[] = 
{
    "IThumbnail",
    "IPreview",
    "ISearch",
...
#define _MaxHandlers_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _MaxHandlers, pIID, n)

int __stdcall _MaxHandlers_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _MaxHandlers, 3, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _MaxHandlers, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _MaxHandlers, 3, *pIndex )
    
}

const ExtendedProxyFileInfo MaxHandlers_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _MaxHandlers_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _MaxHandlers_StubVtblList,
    (const PCInterfaceName * ) & _MaxHandlers_InterfaceNamesList,
    0, /* no delegation */
    & _MaxHandlers_IID_Lookup, 
    3,
    2,
